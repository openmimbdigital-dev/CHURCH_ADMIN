                ...
                <div class="flex flex-col gap-3 justify-between px-5 py-4 sm:flex-row sm:items-center">
                    ...
                    <div class="flex shrink-0 items-center gap-2">
                        ...
                        @can('roles.delete')
                            @if (! $isProtected)
                                @php
                                    $roleDeletable = $role->users_count === 0;
                                    $roleDeleteReason = $role->users_count > 0
                                ...
                                <x-ui.delete-action-button
                                    ...
                                    :record-id="$role->id"
                                    :disabled="! $roleDeletable"
                                    :disabled-reason="$roleDeleteReason"
                                    title="Eliminar rol"
                                    class="!min-h-0 !min-w-0 gap-1.5 px-3 py-1.5 text-xs font-medium"
                                >
                                    <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
