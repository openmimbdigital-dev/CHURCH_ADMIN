    ...
    <header class="mb-6">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-stretch lg:justify-between">
            <div class="min-w-0 flex-1 border-l-4 border-indigo-500 pl-5">
                ...
                <h1 class="mt-2 text-xl font-bold tracking-tight text-slate-900 md:text-2xl">Listado de usuarios</h1>
    ...
    @can('users.create')
        <div class="mb-4 flex justify-end">
            <a
                ...
                wire:navigate
                class="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
            >
